...
#
# Script generated by Vivado on Fri Mar 14 15:47:18 +0200 2025
...
#
# Usage        : BRAM_1.sh
#                BRAM_1.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                BRAM_1.sh [-reset_run]
#                BRAM_1.sh [-reset_log]
#                BRAM_1.sh [-help]
#
...
# script info
echo -e "BRAM_1.sh - Script generated by export_simulation (Vivado v2024.2.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./BRAM_1.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_10 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot BRAM_1 xil_defaultlib.BRAM_1 xil_defaultlib.glbl -log elaborate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb BRAM_1.wdb xsim.dir libdpi.so)
...
Usage: BRAM_1.sh [-step]\n\
Usage: BRAM_1.sh [-lib_map_path]\n\
Usage: BRAM_1.sh [-reset_run]\n\
Usage: BRAM_1.sh [-reset_log]\n\
Usage: BRAM_1.sh [-keep_index]\n\
