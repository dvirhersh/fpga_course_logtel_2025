...
HD_PWD='C:/FPGA/logtel/lab20/lab20.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab20_block_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab20_block_design_wrapper.tcl -notrace
