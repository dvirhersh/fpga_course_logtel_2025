...
#
# lab22_axi_monitor.tcl: Tcl script for re-creating project 'lab22_axi_monitor'
#
# Generated by Vivado on Sun Mar 23 12:03:23 +0200 2025
...
#
# 1. This project restoration tcl script (lab22_axi_monitor.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "C:/FPGA/logtel/lab22_axi_monitor/lab22_axi_monitor.srcs/sources_1/bd/lab22_axi_monitor/ip/lab22_axi_monitor_mig_7series_0_3/board.prj"
#    "C:/FPGA/logtel/lab22_axi_monitor/lab22_axi_monitor.srcs/utils_1/imports/synth_1/lab22_axi_monitor_wrapper.dcp"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/lab22_axi_monitor.srcs/sources_1/bd/lab22_axi_monitor/ip/lab22_axi_monitor_mig_7series_0_3/board.prj"]"\
 "[file normalize "$origin_dir/lab22_axi_monitor.srcs/utils_1/imports/synth_1/lab22_axi_monitor_wrapper.dcp"]"\
  ]
  foreach ifile $files {
...
set _xil_proj_name_ "lab22_axi_monitor"
...
set script_file "lab22_axi_monitor.tcl"
...
set file "lab22_axi_monitor_mig_7series_0_3/board.prj"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "scoped_to_cells" -value "lab22_axi_monitor_mig_7series_0_3" -objects $file_obj


# Set 'sources_1' fileset properties
set obj [get_filesets sources_1]
set_property -name "dataflow_viewer_settings" -value "min_width=16" -objects $obj
set_property -name "top" -value "lab22_axi_monitor_wrapper" -objects $obj
...
set file "synth_1/lab22_axi_monitor_wrapper.dcp"
...
# Proc to create BD lab22_axi_monitor
proc cr_bd_lab22_axi_monitor { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name lab22_axi_monitor
  ...
  connect_bd_intf_net -intf_net axi_smc_M00_AXI [get_bd_intf_pins axi_smc/M00_AXI] [get_bd_intf_pins axi_perf_mon_0/S_AXI]
  ...
  [get_bd_pins axi_perf_mon_0/core_aclk] \
  [get_bd_pins rst_mig_7series_0_81M/slowest_sync_clk] \
  [get_bd_pins jtag_axi_0/aclk] \
  [get_bd_pins axi_smc/aclk] \
  [get_bd_pins axi_perf_mon_0/s_axi_aclk] \
  [get_bd_pins axi_perf_mon_0/slot_0_axi_aclk]
  ...
  [get_bd_pins axi_perf_mon_0/s_axi_aresetn] \
  [get_bd_pins axi_smc/aresetn] \
  [get_bd_pins mig_7series_0/aresetn] \
  [get_bd_pins axi_perf_mon_0/slot_0_axi_aresetn]
  connect_bd_net -net sys_clk_i_1  [get_bd_ports sys_clk_i] \
  [get_bd_pins mig_7series_0/sys_clk_i]

  # Create address segments
  assign_bd_address -offset 0x44A00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces jtag_axi_0/Data] [get_bd_addr_segs axi_perf_mon_0/S_AXI/Reg] -force
...
# End of cr_bd_lab22_axi_monitor()

cr_bd_lab22_axi_monitor ""
set_property REGISTERED_WITH_MANAGER "1" [get_files lab22_axi_monitor.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files lab22_axi_monitor.bd ] 

#call make_wrapper to create wrapper files
if { [get_property IS_LOCKED [ get_files -norecurse [list lab22_axi_monitor.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/lab22_axi_monitor.gen/sources_1/bd/lab22_axi_monitor/hdl/lab22_axi_monitor_wrapper.vhd" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse [list lab22_axi_monitor.bd]] -top]
...
set obj [get_runs synth_1]
set_property -name "incremental_checkpoint" -value "$proj_dir/${_xil_proj_name_}.srcs/utils_1/imports/synth_1/lab22_axi_monitor_wrapper.dcp" -objects $obj
