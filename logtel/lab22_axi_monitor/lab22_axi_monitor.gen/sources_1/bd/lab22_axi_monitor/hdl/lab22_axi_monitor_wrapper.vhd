...
entity lab22_axi_monitor_wrapper is
  port (
...
end lab22_axi_monitor_wrapper;

architecture STRUCTURE of lab22_axi_monitor_wrapper is
  component lab22_axi_monitor is
  port (
    ddr2_sdram_dq : inout STD_LOGIC_VECTOR ( 15 downto 0 );
    ddr2_sdram_dqs_p : inout STD_LOGIC_VECTOR ( 1 downto 0 );
    ddr2_sdram_dqs_n : inout STD_LOGIC_VECTOR ( 1 downto 0 );
  ...
  end component lab22_axi_monitor;
begin
lab22_axi_monitor_i: component lab22_axi_monitor
     port map (
