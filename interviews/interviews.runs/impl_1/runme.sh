...
HD_PWD='C:/fpga_course_logtel_2025/interviews/interviews.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Q1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Q1.tcl -notrace
