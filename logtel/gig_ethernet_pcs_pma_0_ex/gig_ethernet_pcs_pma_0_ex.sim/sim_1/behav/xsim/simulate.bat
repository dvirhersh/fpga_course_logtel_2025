...
REM
REM Generated by Vivado on Mon Mar 17 22:55:13 +0200 2025
...
call xsim  demo_tb_behav -key {Behavioral:sim_1:Functional:demo_tb} -tclbatch demo_tb.tcl -log simulate.log
