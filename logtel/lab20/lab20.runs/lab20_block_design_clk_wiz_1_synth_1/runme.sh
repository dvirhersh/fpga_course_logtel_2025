...
HD_PWD='C:/FPGA/logtel/lab20/lab20.runs/lab20_block_design_clk_wiz_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab20_block_design_clk_wiz_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab20_block_design_clk_wiz_1.tcl
