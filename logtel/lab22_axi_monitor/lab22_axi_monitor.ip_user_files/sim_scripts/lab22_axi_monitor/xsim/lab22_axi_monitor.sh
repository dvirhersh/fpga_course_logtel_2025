...
#
# Script generated by Vivado on Sun Mar 23 17:27:47 +0200 2025
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : lab22_axi_monitor.sh
...
#
# Usage        : lab22_axi_monitor.sh
#                lab22_axi_monitor.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                lab22_axi_monitor.sh [-reset_run]
#                lab22_axi_monitor.sh [-reset_log]
#                lab22_axi_monitor.sh [-help]
#
...
export RDI_DATADIR="C:/Xilinx/Downloads/Vivado/2024.2/data"
...
# script info
echo -e "lab22_axi_monitor.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./lab22_axi_monitor.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L jtag_axi -L axi_perf_mon_v5_0_35 -L lib_cdc_v1_0_3 -L proc_sys_reset_v5_0_16 -L xlconstant_v1_1_9 -L smartconnect_v1_0 -L axi_infrastructure_v1_1_0 -L axi_register_slice_v2_1_33 -L axi_vip_v1_1_19 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot lab22_axi_monitor xil_defaultlib.lab22_axi_monitor xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim lab22_axi_monitor -key {Behavioral:sim_1:Functional:lab22_axi_monitor} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_80ce.protoinst" -protoinst "protoinst_files/lab22_axi_monitor.protoinst" -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Xilinx/Downloads/Vivado/2024.2/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb lab22_axi_monitor.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./lab22_axi_monitor.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: lab22_axi_monitor.sh [-help]\n\
Usage: lab22_axi_monitor.sh [-step]\n\
Usage: lab22_axi_monitor.sh [-lib_map_path]\n\
Usage: lab22_axi_monitor.sh [-reset_run]\n\
Usage: lab22_axi_monitor.sh [-reset_log]\n\
Usage: lab22_axi_monitor.sh [-keep_index]\n\
Usage: lab22_axi_monitor.sh [-noclean_files]\n\n\
