...
#
# Script generated by Vivado on Fri Mar 14 15:45:40 +0200 2025
...
#
# Usage        : ClkGen.sh
#                ClkGen.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ClkGen.sh [-reset_run]
#                ClkGen.sh [-reset_log]
#                ClkGen.sh [-help]
#
...
# script info
echo -e "ClkGen.sh - Script generated by export_simulation (Vivado v2024.2.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ClkGen.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ClkGen xil_defaultlib.ClkGen xil_defaultlib.glbl -log elaborate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb ClkGen.wdb xsim.dir libdpi.so)
...
Usage: ClkGen.sh [-step]\n\
Usage: ClkGen.sh [-lib_map_path]\n\
Usage: ClkGen.sh [-reset_run]\n\
Usage: ClkGen.sh [-reset_log]\n\
Usage: ClkGen.sh [-keep_index]\n\
