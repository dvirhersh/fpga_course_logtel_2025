...
HD_PWD='C:/FPGA/logtel/lab20/lab20.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab20_block_design_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab20_block_design_wrapper.tcl
