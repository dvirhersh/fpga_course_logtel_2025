...
//               c:/FPGA/logtel/lab20_axi_2/lab20_axi_2.gen/sources_1/bd/lab20_2_bd/ip/lab20_2_bd_jtag_axi_0_1/lab20_2_bd_jtag_axi_0_1_stub.v
...
(* CHECK_LICENSE_TYPE = "lab20_2_bd_jtag_axi_0_1,jtag_axi_v1_2_20_jtag_axi,{}" *) (* core_generation_info = "lab20_2_bd_jtag_axi_0_1,jtag_axi_v1_2_20_jtag_axi,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=jtag_axi,x_ipVersion=1.2,x_ipCoreRevision=20,x_ipLanguage=VHDL,x_ipSimLanguage=MIXED,RD_TXN_QUEUE_LENGTH=1,WR_TXN_QUEUE_LENGTH=1,M_AXI_ID_WIDTH=1,M_AXI_ADDR_WIDTH=32,FAMILY=artix7,M_AXI_DATA_WIDTH=32,M_HAS_BURST=1,PROTOCOL=2}" *) (* downgradeipidentifiedwarnings = "yes" *) 
(* x_core_info = "jtag_axi_v1_2_20_jtag_axi,Vivado 2024.2" *) 
module lab20_2_bd_jtag_axi_0_1(aclk, aresetn, m_axi_awaddr, m_axi_awprot, 
