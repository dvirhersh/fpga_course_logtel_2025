...
#
# Script generated by Vivado on Thu Mar 20 09:52:45 +0200 2025
...
#
# Usage        : clk_core.sh
#                clk_core.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                clk_core.sh [-reset_run]
#                clk_core.sh [-reset_log]
#                clk_core.sh [-help]
#
...
# script info
echo -e "clk_core.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./clk_core.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot clk_core xil_defaultlib.clk_core xil_defaultlib.glbl -log elaborate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb clk_core.wdb xsim.dir libdpi.so)
...
Usage: clk_core.sh [-step]\n\
Usage: clk_core.sh [-lib_map_path]\n\
Usage: clk_core.sh [-reset_run]\n\
Usage: clk_core.sh [-reset_log]\n\
Usage: clk_core.sh [-keep_index]\n\
