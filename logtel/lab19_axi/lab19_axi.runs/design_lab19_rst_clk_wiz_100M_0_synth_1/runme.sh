...
HD_PWD='C:/FPGA/logtel/lab19_axi/lab19_axi.runs/design_lab19_rst_clk_wiz_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_lab19_rst_clk_wiz_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_lab19_rst_clk_wiz_100M_0.tcl
