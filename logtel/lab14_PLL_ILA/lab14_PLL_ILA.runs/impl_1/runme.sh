...
HD_PWD='C:/FPGA/logtel/lab14_PLL_ILA/lab14_PLL_ILA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log PLL_CLK.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source PLL_CLK.tcl -notrace
