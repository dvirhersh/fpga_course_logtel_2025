...
#
# Script generated by Vivado on Mon Mar 17 22:54:43 +0200 2025
...
#
# Usage        : gig_ethernet_pcs_pma_0.sh
#                gig_ethernet_pcs_pma_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                gig_ethernet_pcs_pma_0.sh [-reset_run]
#                gig_ethernet_pcs_pma_0.sh [-reset_log]
#                gig_ethernet_pcs_pma_0.sh [-help]
#
...
# script info
echo -e "gig_ethernet_pcs_pma_0.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./gig_ethernet_pcs_pma_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L gig_ethernet_pcs_pma_v16_2_21 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot gig_ethernet_pcs_pma_0 xil_defaultlib.gig_ethernet_pcs_pma_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim gig_ethernet_pcs_pma_0 -key {Behavioral:sim_1:Functional:gig_ethernet_pcs_pma_0} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb gig_ethernet_pcs_pma_0.wdb xsim.dir libdpi.so)
...
Usage: gig_ethernet_pcs_pma_0.sh [-step]\n\
Usage: gig_ethernet_pcs_pma_0.sh [-lib_map_path]\n\
Usage: gig_ethernet_pcs_pma_0.sh [-reset_run]\n\
Usage: gig_ethernet_pcs_pma_0.sh [-reset_log]\n\
Usage: gig_ethernet_pcs_pma_0.sh [-keep_index]\n\
