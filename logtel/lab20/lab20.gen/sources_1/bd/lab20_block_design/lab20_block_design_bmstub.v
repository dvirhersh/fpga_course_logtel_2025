...
module lab20_block_design (
  ...
  (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK_IN1, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN lab20_block_design_clk_in1_0, ASSOCIATED_RESET aresetn, INSERT_VIP 0" *)
  input clk_in1;
  ...
  (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME RST.RESET_1, POLARITY ACTIVE_HIGH, INSERT_VIP 0" *)
  input reset_1;
