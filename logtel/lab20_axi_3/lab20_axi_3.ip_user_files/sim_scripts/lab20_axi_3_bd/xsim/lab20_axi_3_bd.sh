...
#
# Script generated by Vivado on Tue Mar 18 14:23:52 +0200 2025
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : lab20_axi_3_bd.sh
...
#
# Usage        : lab20_axi_3_bd.sh
#                lab20_axi_3_bd.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                lab20_axi_3_bd.sh [-reset_run]
#                lab20_axi_3_bd.sh [-reset_log]
#                lab20_axi_3_bd.sh [-help]
#
...
# script info
echo -e "lab20_axi_3_bd.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./lab20_axi_3_bd.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L jtag_axi -L xlconstant_v1_1_9 -L lib_cdc_v1_0_3 -L proc_sys_reset_v5_0_16 -L smartconnect_v1_0 -L axi_infrastructure_v1_1_0 -L axi_register_slice_v2_1_33 -L axi_vip_v1_1_19 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot lab20_axi_3_bd xil_defaultlib.lab20_axi_3_bd xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim lab20_axi_3_bd -key {Behavioral:sim_1:Functional:lab20_axi_3_bd} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_cc91.protoinst" -protoinst "protoinst_files/lab20_axi_3_bd.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb lab20_axi_3_bd.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./lab20_axi_3_bd.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: lab20_axi_3_bd.sh [-help]\n\
Usage: lab20_axi_3_bd.sh [-step]\n\
Usage: lab20_axi_3_bd.sh [-lib_map_path]\n\
Usage: lab20_axi_3_bd.sh [-reset_run]\n\
Usage: lab20_axi_3_bd.sh [-reset_log]\n\
Usage: lab20_axi_3_bd.sh [-keep_index]\n\
Usage: lab20_axi_3_bd.sh [-noclean_files]\n\n\
