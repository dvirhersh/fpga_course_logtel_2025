...
HD_PWD='C:/FPGA/logtel/lab16_pipeline/lab16_pipeline.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pipelining.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pipelining.tcl
