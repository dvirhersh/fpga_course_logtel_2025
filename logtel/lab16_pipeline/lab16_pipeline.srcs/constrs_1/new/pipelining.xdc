...
# set_input_delay -clock [get_clocks CLOCK] -min -add_delay 2.000 [get_ports {A[*]}]
# set_input_delay -clock [get_clocks CLOCK] -max -add_delay 2.000 [get_ports {A[*]}]
# set_input_delay -clock [get_clocks CLOCK] -min -add_delay 2.000 [get_ports {B[*]}]
# set_input_delay -clock [get_clocks CLOCK] -max -add_delay 2.000 [get_ports {B[*]}]
# set_input_delay -clock [get_clocks CLOCK] -min -add_delay 2.000 [get_ports RESET]
# set_input_delay -clock [get_clocks CLOCK] -max -add_delay 2.000 [get_ports RESET]
# set_output_delay -clock [get_clocks CLOCK] -min -add_delay 0.000 [get_ports COMP_OUT]
# set_output_delay -clock [get_clocks CLOCK] -max -add_delay 2.000 [get_ports COMP_OUT]
