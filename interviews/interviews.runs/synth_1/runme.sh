...
HD_PWD='C:/fpga_course_logtel_2025/interviews/interviews.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Q1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Q1.tcl
