...
HD_PWD='C:/fpga_course_logtel_2025/SystemVerilog/SystemVerilog.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log register8.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source register8.tcl -notrace
