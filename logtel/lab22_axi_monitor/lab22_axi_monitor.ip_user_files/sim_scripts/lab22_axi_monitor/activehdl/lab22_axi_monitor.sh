...
#                script (type 'lab22_axi_monitor.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/FPGA/logtel/lab22_axi_monitor/lab22_axi_monitor.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
